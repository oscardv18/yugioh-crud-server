...
const UserFactory_1 = __importDefault(require("./routes/api/v1/Factories/UserFactory"));
const BuyedCardsFactory_1 = __importDefault(require("./routes/api/v1/Factories/BuyedCardsFactory"));
dotenv_1.default.config();
const app = (0, express_1.default)();
app.use("/api/v1/cards", cardsDeck_1.default);
app.use("/api/v1/factories/cards", BuyedCardsFactory_1.default);
app.use("/api/v1/factories/user", UserFactory_1.default);
